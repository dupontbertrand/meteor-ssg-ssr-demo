...
FlowRouter.route('/', {
  name: 'home',
  action() {
    this.render('mainLayout', { content: 'home' });
  },
});
...
FlowRouter.route('/about', {
  ...
  action() {
    this.render('mainLayout', { content: 'about' });
  },
});
...
FlowRouter.route('/contact', {
  ...
  action() {
    this.render('mainLayout', { content: 'contact' });
  },
});
...
FlowRouter.route('/articles/:slug', {
  ...
  action() {
    this.render('mainLayout', { content: 'productPage' });
  },
});
...
FlowRouter.route('/stocks', {
  name: 'stocks',
  action() {
    this.render('mainLayout', { content: 'stocksPage' });
  },
});
...
FlowRouter.route('*', {
  name: 'notFound',
  action() {
    this.render('mainLayout', { content: 'notFound' });
  },
});
