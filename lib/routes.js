...
import { esc, jsonLd } from './escape.js';
...
FlowRouter.route('/about', {
  ...
  staticHead() {
    return '<title>About | MyShop</title>' +
      ...
      '<link rel="canonical" href="https://ssg-ssr-demo.sandbox.galaxycloud.app/about">' +
...
FlowRouter.route('/contact', {
  ...
  staticHead() {
    return '<title>Contact | MyShop</title>' +
      ...
      '<link rel="canonical" href="https://ssg-ssr-demo.sandbox.galaxycloud.app/contact">' +
...
FlowRouter.route('/articles/:slug', {
  ...
  async staticHead(params) {
    ...
    const url = `https://ssg-ssr-demo.sandbox.galaxycloud.app/articles/${p.slug}`;
